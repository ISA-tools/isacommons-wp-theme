...
<head>
	...
	<![endif]-->
	<?php wp_head(); ?>
	<link rel="stylesheet" href="/wp-content/themes/isacommons-wp-theme/assets/css/isatools.css" type="text/css"/>
...
<header id="masthead" class="site-header" role="banner">
	<div class="commons-logo">
		...
		<a href="http://isa-tools.org/publications" class="head-link pull-right" alt="Twitter"> <span class="fa fa-twitter"></span> </a>
		<a href="http://www.facebook.com/isatools" class="head-link pull-right" alt="Twitter"> <span class="fa fa-facebook"></span> </a>
